...
public class CalculatorWithoutLocationTracking implements WaitTimeCalculator {
 
    public CalculatorWithoutLocationTracking() {
    }
    ...
    public int getWaitTime (String ID){
        ...
        double estWaitTime = ( ((60-timeSinceLastUpdated) * dbWaitTime.getCurrentWaitTime()) / 60 ) +
                             ( (timeSinceLastUpdated * bdsWaitTime.getWaitTime()) / 60) + 0.5;
